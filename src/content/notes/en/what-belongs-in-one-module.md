...
That is roughly what cohesion measures: how related the elements inside a module are. Strong relatedness gives the module one reason to exist, which makes it easier to read and less likely to be dragged into changes that have nothing to do with it.
